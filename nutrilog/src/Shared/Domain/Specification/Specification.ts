...
export class StartsWith<C extends Composite<C, T>, T extends C | Composite<C, T>> extends Composite<C, T> {
...
export class EndsWith<C extends Composite<C, T>, T extends C | Composite<C, T>> extends Composite<C, T> {
...
export class Contains<C extends Composite<C, T>, T extends C | Composite<C, T>> extends Composite<C, T> {
...
export class LengthBetween<C extends Composite<C, T>, T extends C | Composite<C, T>> extends Composite<C, T> {
...
export class Matches<C extends Composite<C, T>, T extends C | Composite<C, T>> extends Composite<C, T> {
